...
module.exports = {
    ...
    execute(message, args) {
        if ((message.member.roles.cache.has("408261421894205440")) || (message.member.roles.cache.has("699538325341601802")) || (message.author.id === "234058359567810570")) {
            let role_list = ["468813265347149826", "777147301290049536", "826473836627099768", "554752144507535370", "554752141521059841", "829316900013342771", "554756261485215783", "829316948100644875", "554752141978370078", "554752141982433280", "554752142229897226", "554752141831438336"]
            ...
            role_list.forEach(r => {
                ...
                ListEmbed.addFields(
                    { name: role_info.name.toString(), value: role_count },
                )
            });
